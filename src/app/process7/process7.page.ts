...
@Component({
  selector: 'app-process7',
  templateUrl: './process7.page.html',
  styleUrls: ['./process7.page.scss'],
})
export class Process7Page implements OnInit {
  form:FormGroup;
  form1:FormGroup;
