...
@Component({
  selector: 'app-process9',
  templateUrl: './process9.page.html',
  styleUrls: ['./process9.page.scss'],
})
export class Process9Page implements OnInit {
