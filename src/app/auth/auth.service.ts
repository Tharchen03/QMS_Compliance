...
export class AuthService {
  ...
  signup(email: string, password:string){
    ...
    .post  <AuthResponseData>(
      `https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyD44DcHS5NQqhwWG0c5yUJURYZwKvmRxTs`,
  ...
  login(email:string, password:string){
    return this.http
    .post<AuthResponseData>(
      `https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyD44DcHS5NQqhwWG0c5yUJURYZwKvmRxTs`,
      {email:email, password:password, returnSecureToken: true}
    )
    .pipe(tap(this.setUserData.bind(this)));
  }
