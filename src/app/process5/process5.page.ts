...
@Component({
  selector: 'app-process5',
  templateUrl: './process5.page.html',
  styleUrls: ['./process5.page.scss'],
})
export class Process5Page implements OnInit {
  form:FormGroup;
  form1:FormGroup;
  form2:FormGroup;
